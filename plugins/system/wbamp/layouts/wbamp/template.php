...
<div class="wbamp-wrapper">
	...
	// modules in wbamp-header position
	if (WbampHelper_Edition::$id == 'full' && !empty($displayData['top_module_position']))
	{
		echo ShlMvcLayout_Helper::render('wbamp.position', $displayData['top_module_position'], WbampHelper_Runtime::$layoutsBasePaths);
	}

	// Main content
	echo ShlMvcLayout_Helper::render('wbamp.content', $displayData, WbampHelper_Runtime::$layoutsBasePaths);

	// modules in wbamp-footer position
	if (WbampHelper_Edition::$id == 'full' && !empty($displayData['bottom_module_position']))
	{
		echo ShlMvcLayout_Helper::render('wbamp.position', $displayData['bottom_module_position'], WbampHelper_Runtime::$layoutsBasePaths);
	}
